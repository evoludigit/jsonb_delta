...
-- released chain 0.1.0 -> 0.2.0 -> 0.3.0.
-- Requires sql/jsonb_delta--0.1.0.sql plus every upgrade script
-- (--0.1.0--0.2.0.sql, --0.2.0--0.3.0.sql) to be present in the server's
...
-- The upgraded functions must actually resolve and run on the 0.3.0 module.
...
\echo 'upgrade path 0.1.0 -> 0.2.0 -> 0.3.0 OK'
